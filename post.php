...
if(isset($_POST['pub']))
    {
        ...
        $query=$connected->prepare("INSERT INTO article(postBY,title,text,Date_create) VALUES('$postBy','$title','$text',current_timestamp() )");
        $query->execute();
    }
                     ...
                     $post2=' 
                        ...
                        $post4='
                            ...
                            <div class ="post_right">
                                ...
                                <div class="title_post"> <h3>'.$var['title'].'</h1>
                                </div> 

                                <div class="text_post">'.$var['text'].'
                                </div>
                                ...
                                <div class="date_post"> 
                                        ...
                                        <form action="post.php" method="POST" class="post_sup">
                                            <button name="sup" type="submit" class="post_sup" value="'.$var['IDA'].'"><img src="./img/OIP.png" class="image_modf"> </button>
                                        </form>
